/*! For license information please see MMM-TeslamateLocation2.js.LICENSE.txt */
(() => {
    var t = {
        244: function (t, e) {
            !function (t) {
                ...
                qe = z.extend({
                    ...
                    panBy: function (t, e) {
                        ...
                        if (this._panAnim || (this._panAnim = new Ve, this._panAnim.on({
                            ...
                            le(this._mapPane, "leaflet2-pan-anim");
                    ...
                    createPane: function (t, e) {
                        var n = ne("div", "leaflet2-pane" + (t ? " leaflet2-" + t.replace("Pane", "") + "-pane" : ""), e || this._mapPane);
                    ...
                    _initLayout: function () {
                        ...
                        le(t, "leaflet2-container" + (xt ? " leaflet2-touch" : "") + (Lt ? " leaflet2-retina" : "") + (J ? " leaflet2-oldie" : "") + (ut ? " leaflet2-safari" : "") + (this._fadeAnimated ? " leaflet2-fade-anim" : ""));
                        var e = ee(t, "position");
                    ...
                    _initPanes: function () {
                        ...
                        this.options.markerZoomAnimation || (le(t.markerPane, "leaflet2-zoom-hide"), le(t.shadowPane, "leaflet2-zoom-hide"))
                    },
                    ...
                    _onPanTransitionEnd: function () {
                        ue(this._mapPane, "leaflet2-pan-anim"),
                        this.fire("moveend")
                    },
                    ...
                    _createAnimProxy: function () {
                        var t = this._proxy = ne("div", "leaflet2-proxy leaflet2-zoom-animated");
                    ...
                    _nothingToAnimate: function () {
                        return !this._container.getElementsByClassName("leaflet2-zoom-animated").length
                    },
                    ...
                    _animateZoom: function (t, e, n, o) {
                        this._mapPane && (n && (this._animatingZoom = !0, this._animateToCenter = t, this._animateToZoom = e, le(this._mapPane, "leaflet2-zoom-anim")), this.fire("zoomanim", {
                                center: t,
                                zoom: e,
                                noUpdate: o
                    ...
                    _onZoomTransitionEnd: function () {
                        this._animatingZoom && (this._mapPane && ue(this._mapPane, "leaflet2-zoom-anim"), this._animatingZoom = !1, this._move(this._animateToCenter, this._animateToZoom), P((function () {
                                    this._moveEnd(!0)
                                }), this))
                    }
                });
                ...
                var Qe = $e.extend({
                    ...
                    expand: function () {
                        le(this._container, "leaflet2-control-layers-expanded"),
                        this._section.style.height = null;
                        var t = this._map.getSize().y - (this._container.offsetTop + 50);
                        return t < this._section.clientHeight ? (le(this._section, "leaflet2-control-layers-scrollbar"), this._section.style.height = t + "px") : ue(this._section, "leaflet2-control-layers-scrollbar"),
                        this._checkDisabledLayers(),
                        this
                    },
                    collapse: function () {
                        return ue(this._container, "leaflet2-control-layers-expanded"),
                        this
                    },
                    _initLayout: function () {
                        var t = "leaflet2-control-layers",
                    ...
                    _createRadioElement: function (t, e) {
                        var n = '<input type="radio" class="leaflet2-control-layers-selector" name="' + t + '"' + (e ? ' checked="checked"' : "") + "/>",
                    ...
                    _addItem: function (t) {
                        ...
                        t.overlay ? ((e = document.createElement("input")).type = "checkbox", e.className = "leaflet2-control-layers-selector", e.defaultChecked = i) : e = this._createRadioElement("leaflet2-base-layers_" + r(this), i),
                ...
                Ge = $e.extend({
                    ...
                    onAdd: function (t) {
                        var e = "leaflet2-control-zoom",
                        n = ne("div", e + " leaflet2-bar"),
                        i = this.options;
                ...
                Xe = $e.extend({
                    ...
                    onAdd: function (t) {
                        for (var e in t.attributionControl = this, this._container = ne("div", "leaflet2-control-attribution"), Ne(this._container), t._layers)
                ...
                an = z.extend({
                    ...
                    _onDown: function (t) {
                        if (!t._simulated && this._enabled && (this._moved = !1, !se(this._element, "leaflet2-zoom-anim") && !(an._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || (an._dragging = this, this._preventOutline && be(this._element), ve(), qt(), this._moving)))) {
                            this.fire("down");
                    ...
                    _onMove: function (t) {
                        if (!t._simulated && this._enabled)
                            if (t.touches && t.touches.length > 1)
                                ...
                                (n.x || n.y) && (Math.abs(n.x) + Math.abs(n.y) < this.options.clickTolerance || (n.x /= this._parentScale.x, n.y /= this._parentScale.y, Re(t), this._moved || (this.fire("dragstart"), this._moved = !0, this._startPos = _e(this._element).subtract(n), le(document.body, "leaflet2-dragging"), this._lastTarget = t.target || t.srcElement, window.SVGElementInstance && this._lastTarget instanceof window.SVGElementInstance && (this._lastTarget = this._lastTarget.correspondingUseElement), le(this._lastTarget, "leaflet2-drag-target")), this._newPos = this._startPos.add(n), this._moving = !0, S(this._animRequest), this._lastEvent = t, this._animRequest = P(this._updatePosition, this, !0)))
                            }
                    },
                    ...
                    finishDrag: function () {
                        for (var t in ue(document.body, "leaflet2-dragging"), this._lastTarget && (ue(this._lastTarget, "leaflet2-drag-target"), this._lastTarget = null), rn)
                ...
                Cn = T.extend({
                    ...
                    _setIconStyles: function (t, e) {
                        ...
                        t.className = "leaflet2-marker-" + e + " " + (n.className || ""),
                ...
                var zn = Cn.extend({
                    ...
                    _detectIconPath: function () {
                        var t = ne("div", "leaflet2-default-icon-path", document.body),
                ...
                Mn = Je.extend({
                    ...
                    addHooks: function () {
                        ...
                        le(t, "leaflet2-marker-draggable")
                    },
                    removeHooks: function () {
                        ...
                        this._marker._icon && ue(this._marker._icon, "leaflet2-marker-draggable")
                    },
                    moved: function () {
                ...
                On = Sn.extend({
                    ...
                    _initIcon: function () {
                        var t = this.options,
                        e = "leaflet2-zoom-" + (this._zoomAnimated ? "animated" : "hide"),
                    ...
                    _initInteraction: function () {
                        if (this.options.interactive && (le(this._icon, "leaflet2-interactive"), this.addInteractiveTarget(this._icon), Mn)) {
                ...
                Gn = Sn.extend({
                    ...
                    onAdd: function () {
                        ...
                        this.options.interactive && (le(this._image, "leaflet2-interactive"), this.addInteractiveTarget(this._image)),
                    ...
                    _initImage: function () {
                        ...
                        le(e, "leaflet2-image-layer"),
                        this._zoomAnimated && le(e, "leaflet2-zoom-animated"),
                ...
                Yn = Gn.extend({
                    ...
                    _initImage: function () {
                        ...
                        if (le(e, "leaflet2-image-layer"), this._zoomAnimated && le(e, "leaflet2-zoom-animated"), this.options.className && le(e, this.options.className), e.onselectstart = l, e.onmousemove = l, e.onloadeddata = i(this.fire, this, "load"), t) {
                ...
                var Xn = Gn.extend({
                    _initImage: function () {
                        ...
                        le(t, "leaflet2-image-layer"),
                        this._zoomAnimated && le(t, "leaflet2-zoom-animated"),
                ...
                ti = Jn.extend({
                    ...
                    _initLayout: function () {
                        var t = "leaflet2-popup",
                        e = this._container = ne("div", t + " " + (this.options.className || "") + " leaflet2-zoom-animated"),
                ...
                var ei = Jn.extend({
                    ...
                    _initLayout: function () {
                        var t = "leaflet2-tooltip " + (this.options.className || "") + " leaflet2-zoom-" + (this._zoomAnimated ? "animated" : "hide");
                    ...
                    _setPosition: function (t) {
                        ...
                        ue(o, "leaflet2-tooltip-right"),
                        ue(o, "leaflet2-tooltip-left"),
                        ue(o, "leaflet2-tooltip-top"),
                        ue(o, "leaflet2-tooltip-bottom"),
                        le(o, "leaflet2-tooltip-" + s),
                        me(o, t)
                    },
                    _updatePosition: function () {
                        var t = this._map.latLngToLayerPoint(this._latlng);
                ...
                Sn.include({
                    ...
                    openTooltip: function (t, e) {
                        return this._tooltip && this._map && (e = this._tooltip._prepareOpen(this, t, e), this._map.openTooltip(this._tooltip, e), this._tooltip.options.interactive && this._tooltip._container && (le(this._tooltip._container, "leaflet2-clickable"), this.addInteractiveTarget(this._tooltip._container))),
                        this
                    },
                    closeTooltip: function () {
                        return this._tooltip && (this._tooltip._close(), this._tooltip.options.interactive && this._tooltip._container && (ue(this._tooltip._container, "leaflet2-clickable"), this.removeInteractiveTarget(this._tooltip._container))),
                        this
                    },
                ...
                var ii = Sn.extend({
                    ...
                    _initContainer: function () {
                        this._container || (this._container = ne("div", "leaflet2-layer " + (this.options.className || "")), this._updateZIndex(), this.options.opacity < 1 && this._updateOpacity(), this.getPane().appendChild(this._container))
                    },
                    _updateLevels: function () {
                        ...
                        if (void 0 !== t) {
                            ...
                            o = this._map;
                            return i || ((i = this._levels[t] = {}).el = ne("div", "leaflet2-tile-container leaflet2-zoom-animated", this._container), i.el.style.zIndex = e, i.origin = o.project(o.unproject(o.getPixelOrigin()), t).round(), i.zoom = t, this._setZoomTransform(i, o.getCenter(), o.getZoom()), i.el.offsetWidth, this._onCreateLevel(i)),
                            this._level = i,
                            i
                        }
                    },
                    ...
                    _tileReady: function (t, e, n) {
                        ...
                        (n = this._tiles[o]) && (n.loaded = +new Date, this._map._fadeAnimated ? (de(n.el, 0), S(this._fadeFrame), this._fadeFrame = P(this._updateOpacity, this)) : (n.active = !0, this._pruneTiles()), e || (le(n.el, "leaflet2-tile-loaded"), this.fire("tileload", {
                                    tile: n.el,
                                    coords: t
                ...
                var si = Sn.extend({
                    ...
                    onAdd: function () {
                        this._container || (this._initContainer(), this._zoomAnimated && le(this._container, "leaflet2-zoom-animated")),
                        this.getPane().appendChild(this._container),
                        this._update(),
                ...
                li = si.extend({
                    ...
                    _handleMouseOut: function (t) {
                        ...
                        e && (ue(this._container, "leaflet2-interactive"), this._fireEvent([e], t, "mouseout"), this._hoveredLayer = null, this._mouseHoverThrottled = !1)
                    },
                    _handleMouseHover: function (t, e) {
                        if (!this._mouseHoverThrottled) {
                            for (var n, o, r = this._drawFirst; r; r = r.next)
                                (n = r.layer).options.interactive && n._containsPoint(e) && (o = n);
                            o !== this._hoveredLayer && (this._handleMouseOut(t), o && (le(this._container, "leaflet2-interactive"), this._fireEvent([o], t, "mouseover"), this._hoveredLayer = o)),
                ...
                hi = {
                    _initContainer: function () {
                        this._container = ne("div", "leaflet2-vml-container")
                    },
                    _update: function () {
                    ...
                    _initPath: function (t) {
                        ...
                        le(e, "leaflet2-vml-shape " + (this.options.className || "")),
                        e.coordsize = "1 1",
                        t._path = ci("path"),
                ...
                di = Ct ? ci : Q,
                    ...
                    _initPath: function (t) {
                        ...
                        t.options.interactive && le(e, "leaflet2-interactive"),
                        this._updateStyle(t),
                        this._layers[r(t)] = t
                    },
                    _addPath: function (t) {
                ...
                var _i = Je.extend({
                    ...
                    _onMouseMove: function (t) {
                        this._moved || (this._moved = !0, this._box = ne("div", "leaflet2-zoom-box", this._container), le(this._container, "leaflet2-crosshair"), this._map.fire("boxzoomstart")),
                    ...
                    _finish: function () {
                        this._moved && (ie(this._box), ue(this._container, "leaflet2-crosshair")),
                        $t(),
                        ye(),
                        Ee(document, {
                            contextmenu: Ae,
                ...
                var vi = Je.extend({
                    addHooks: function () {
                        ...
                        le(this._map._container, "leaflet2-grab leaflet2-touch-drag"),
                        this._draggable.enable(),
                        this._positions = [],
                        this._times = []
                    },
                    removeHooks: function () {
                        ue(this._map._container, "leaflet2-grab"),
                        ue(this._map._container, "leaflet2-touch-drag"),
                ...
                var wi = Je.extend({
                    ...
                    _onDown: function (t) {
                        if (t.touches) {
                            ...
                            n.tagName && "a" === n.tagName.toLowerCase() && le(n, "leaflet2-active"),
                    ...
                    _onUp: function (t) {
                        if (clearTimeout(this._holdTimeout), Ee(document, {
                            ...
                            n = e.target;
                            n && n.tagName && "a" === n.tagName.toLowerCase() && ue(n, "leaflet2-active"),
                ...
                var xi = Je.extend({
                    addHooks: function () {
                        le(this._map._container, "leaflet2-touch-zoom"),
                        Le(this._map._container, "touchstart", this._onTouchStart, this)
                    },
                    removeHooks: function () {
                        ue(this._map._container, "leaflet2-touch-zoom"),
    ...
    (() => {
        ...
        _ = function (t) {
            var e = t.coords,
            n = a().map;
            return console.log("ChangeMapView2", e, n.getZoom()),
        ...
        const b = function (e) {
            function n(t) {
                ...
                window.setLatitude2 = function (t) {
                    console.log("setLatitude2", t),
                    n.setState({
                        center: {
                            lat: t,
                ...
                window.setLongitude2 = function (t) {
                    console.log("setLongitude2", t),
                    n.setState({
                        center: {
            ...
            n.prototype.render = function () {
                return console.log("MapView2.render", this.state),
                (0, t.jsx)(g, {
        ...
        (i.Component);
        Module.register("MMM-TeslamateLocation2", {
            defaults: {
                height: "300px",
                width: "100%",
                zoomLevel: 20,
            ...
            getDom: function () {
                var t = document.createElement("div");
                return t.classList.add("mmm-teslamatelocation2-app"),
                t
            },
            createMap: function () {
                var n = document.getElementsByClassName("mmm-teslamatelocation2-app");
                if (n.length > 0) {
            ...
            socketNotificationReceived: function (t, e) {
                if (console.log(this.name + " socketNotificationReceived " + t + " Topic: " + e.topic + " JSON: " + e.value), "MQTT_PAYLOAD2" === t && null != e) {
                    var n = parseFloat(e.value);
                    e.topic.endsWith("latitude") && window.setLatitude2 && window.setLatitude2(n),
                    e.topic.endsWith("longitude") && window.setLongitude2 && window.setLongitude2(n)
                }
            },
