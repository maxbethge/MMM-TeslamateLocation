...
Module.register<MainPageProps>("MMM-TeslamateLocation", {
  ...
  start: function () {
    ...
    Log.log('[MMM-MyTeslamateLocation] ' + "1Setting up connection to MQTT Broker " +  this.config.mqttServerAddress + " at port " + this.config.mqttServerPort);
    this.Log.log('[MMM-MyTeslamateLocation] ' + "2Setting up connection to MQTT Broker " +  this.config.mqttServerAddress + " at port " + this.config.mqttServerPort);
